...
const ProfileAdmin = () => {
  ...
  return (
    <>
      <div style={{
        backgroundColor: 'white', width: '100vw', display: "flex",
        alignItems: "center",
      }}>
...
backgroundColor:'white'
        ...
        <div className="p-4 box" style={{
          width: '50%', height: '80%', backgroundColor: 'white', mariginBottom: '10px', marginTop: '70px', marginLeft: '100px', border: '1px solid',
          padding: '10px',
          ...
          {avatarUrl ? <img src={`https://dfvcmxwvvqvmnpikczag.supabase.co/storage/v1/object/public/avatars/${avatarUrl}`} alt="profilepic" className="avatar" style={{
